...
def validate_investment_banking_data(data: Dict[str, Any], required_fields: List[str]) -> bool:
    ...
    if missing_fields:
        raise FinancialDataError(
            ...
            context={"provided_fields": list(data.keys()), "missing_fields": missing_fields}
        )
