...
def demo_configuration_system():
    ...
    try:
        ...
        print(f"✅ M&A Due Diligence AI Provider: {ma_dd_config.primary_provider.value}")
        ...
        print(f"✅ Required AI Providers: {', '.join(p.value for p in required_providers)}")
...
def demo_schemas():
    ...
    try:
        from axiom.config.schemas import (
            SearchQuery, TaskPlan, Evidence, Citation, ResearchBrief
        )
        ...
        brief = ResearchBrief(
            ...
            questions_answered=["What are the strategic synergies?", "What is the financial impact?"],
...
def demo_ai_provider_abstraction():
    ...
    try:
        from axiom.ai_client_integrations.base_ai_provider import BaseAIProvider, AIMessage, AIResponse
    ...
    try:
        ...
        analysis_data = {
            ...
            "evidence": [
                ...
                {"source_url": "https://bloomberg.com/article", "content": "Market analysis"}, 
                {"source_url": "https://reuters.com/news", "content": "Industry analysis"}
            ]
        }
...
def demo_ma_query_analysis():
    ...
    try:
        ...
        # Test M&A query
        ma_query = "Microsoft acquisition of OpenAI strategic analysis and due diligence"
...
def main():
    ...
    if successful_demos == total_demos:
        ...
        print("3. Test live analysis: python -m axiom.main 'Microsoft OpenAI M&A analysis'")
        return 0
    else:
