...
def demo_ma_workflows():
    ...
    try:
        from axiom.core.analysis_engines.target_screening import TargetCriteria, TargetProfile
    ...
    print("   from axiom.core.analysis_engines.target_screening import run_target_screening, TargetCriteria")
    print(
    ...
    print("\n2. Due Diligence:")
    print("   from axiom.core.analysis_engines.due_diligence import run_comprehensive_dd")
    print("   dd_results = await run_comprehensive_dd('Target Company')")

    print("\n3. Valuation:")
    print("   from axiom.core.analysis_engines.valuation import run_comprehensive_valuation")
