...
def demo_enhanced_ma_workflows():
    ...
    try:
        from axiom.core.analysis_engines.risk_assessment import (
    ...
    try:
        from axiom.core.analysis_engines.regulatory_compliance import (
            HSRAnalysis,
    ...
    print("   from axiom.core.analysis_engines.risk_assessment import run_advanced_risk_assessment")
    print("   risk_result = await run_advanced_risk_assessment('DataRobot Inc', 2.8e9)")

    print("\n2. Regulatory Compliance:")
    print("   from axiom.core.analysis_engines.regulatory_compliance import run_regulatory_compliance_analysis")
    print("   regulatory = await run_regulatory_compliance_analysis('OpenAI', 'Microsoft', 10e9)")

    print("\n3. HSR Filing Analysis:")
    print("   from axiom.core.analysis_engines.regulatory_compliance import run_hsr_analysis")
