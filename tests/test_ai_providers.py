...
class TestOpenAIProvider:
    ...
    def mock_openai_client(self):
        """Mock OpenAI client."""
        with patch('axiom.ai_client_integrations.openai_provider.OpenAI') as mock_client:
            yield mock_client
...
class TestClaudeProvider:
    ...
    def mock_anthropic_client(self):
        ...
        with patch('axiom.ai_client_integrations.claude_provider.Anthropic') as mock_client:
            yield mock_client
...
class TestSGLangProvider:
    ...
    def mock_sglang_client(self):
        ...
        with patch('axiom.ai_client_integrations.sglang_provider.OpenAI') as mock_client:
            yield mock_client
